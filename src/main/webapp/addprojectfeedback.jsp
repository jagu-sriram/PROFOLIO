...
<html lang="en">
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/intlTelInput.min.js"></script>
    ...
    <c:out value="${message}"></c:out>
            ...
            <form action="addprojectfeedback" method="post" class="form" enctype="multipart/form-data">
              ...
              <div class="input-box address">
                ...
                <textarea rows="10" cols="100" name="pcomments" placeholder="Add your comments"></textarea>
