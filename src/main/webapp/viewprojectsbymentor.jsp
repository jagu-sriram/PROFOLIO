                ...
                <c:forEach var="project" items="${projectslist}">
                    <div class="view_item">
                        <div class="vi_left">
                            ...
                            <p class="content">Submitted By: <c:out value="${project.student.id}-${project.student.lastname}"/></p>
                             <a class="btn view-more-btn" href='<c:url value="viewprojectdetailsbymentor?id=${project.id}"></c:url>'>View More</a>
                        </div>
                        <div class="vi_right">
